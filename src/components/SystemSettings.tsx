  ...
  return (
    <div className={`
      ${isMobile 
        ...
        : 'bg-gray-900/95 backdrop-blur-xl border border-orange-500/30 w-full rounded-3xl p-8 max-w-4xl'
      }
    `}>
      {/* Header */}
      <div className={`
        flex items-center justify-between mb-8
        ${isMobile ? 'mb-4 pb-4 border-b border-orange-500/20' : 'mb-8'}
      `}>
        <h2 className={`
          font-bold text-white flex items-center gap-3
          ${isMobile ? 'text-xl' : 'text-3xl'}
        `}>
          <Sliders className={`text-orange-400 ${isMobile ? 'w-6 h-6' : 'w-8 h-8'}`} />
        ...
        <div className="flex items-center gap-4">
          {!isMobile && (
            <button
              ...
              className="bg-orange-500/20 hover:bg-orange-500/30 text-orange-400 px-4 py-2 rounded-xl
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300">
              ...
              <input
                ...
                className="w-full accent-orange-500 bg-gray-700 rounded-lg"
              />
            </div>
            <div className="p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300">
              <div className="flex items-center gap-3 mb-4">
